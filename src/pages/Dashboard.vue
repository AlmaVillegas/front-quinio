...
export default {
  ...
  methods:{
    ...
    getContent(){
      const vm = this;
       vm.axios.get('http://localhost:4422/content').then(response => {
         alert('Se realizo el registro de datos')
         console.log(response)
     });
    },
    getNexTable(){
      const vm = this;
       vm.axios.get('http://localhost:4422/addTransaction').then(response => {
         console.log(response)
     });
    }
  }
